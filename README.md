...
[![GitHub version](https://img.shields.io/github/package-json/v/bing0b0ng0/binance-trading-fabio)](https://github.com/bing0b0ng0/binance-trading-fabio/releases)
[![Build](https://github.com/bing0b0ng0/binance-trading-fabio/workflows/Push/badge.svg)](https://github.com/bing0b0ng0/binance-trading-fabio/actions?query=workflow%3APush)
[![CodeCov](https://codecov.io/gh/bing0b0ng0/binance-trading-fabio/branch/master/graph/badge.svg)](https://codecov.io/gh/bing0b0ng0/binance-trading-fabio)
[![Docker pull](https://img.shields.io/docker/pulls/bing0b0ng0/binance-trading-fabio)](https://hub.docker.com/r/bing0b0ng0/binance-trading-fabio)
[![GitHub contributors](https://img.shields.io/github/contributors/bing0b0ng0/binance-trading-fabio)](https://github.com/bing0b0ng0/binance-trading-fabio/graphs/contributors)
[![MIT License](https://img.shields.io/github/license/bing0b0ng0/binance-trading-fabio)](https://github.com/bing0b0ng0/binance-trading-fabio/blob/master/LICENSE)

> Automated Binance trading bot with trailing buy/sell strategy

---

[![ko](https://img.shields.io/badge/lang-한국어-brightgreen.svg)](https://github.com/bing0b0ng0/binance-trading-fabio/blob/master/README.ko.md)
[![中文](https://img.shields.io/badge/lang-中文-blue.svg)](https://github.com/bing0b0ng0/binance-trading-fabio/blob/master/README.zh-cn.md)
...
[https://github.com/bing0b0ng0/binance-trading-fabio/wiki/Buy-Scenario](https://github.com/bing0b0ng0/binance-trading-fabio/wiki/Buy-Scenario)
...
[https://github.com/bing0b0ng0/binance-trading-fabio/wiki/Sell-Scenario](https://github.com/bing0b0ng0/binance-trading-fabio/wiki/Sell-Scenario)

### [Features](https://github.com/bing0b0ng0/binance-trading-fabio/wiki/Features)
...
3. Open browser `http://0.0.0.0:8080` to see the frontend
   ...
   - If you have any issue with the bot, you can check the log to find out what happened with the bot. Please take a look [Troubleshooting](https://github.com/bing0b0ng0/binance-trading-fabio/wiki/Troubleshooting)
...
Please refer
[CHANGELOG.md](https://github.com/bing0b0ng0/binance-trading-fabio/blob/master/CHANGELOG.md)
to view the past changes.

- [ ] Develop simple setup screen for secrets
- [ ] Allow to execute stop-loss before buy action - [#299](https://github.com/bing0b0ng0/binance-trading-fabio/issues/299)
- [ ] Improve sell strategy with conditional stop price percentage based on the profit percentage - [#94](https://github.com/bing0b0ng0/binance-trading-fabio/issues/94)
- [ ] Add sudden drop buy strategy - [#67](https://github.com/bing0b0ng0/binance-trading-fabio/issues/67)
- [ ] Manage setting profiles (save/change/load?/export?) - [#151](https://github.com/bing0b0ng0/binance-trading-fabio/issues/151)
- [ ] Improve notifications by supporting Apprise - [#106](https://github.com/bing0b0ng0/binance-trading-fabio/issues/106)
- [ ] Support cool time after hitting the lowest price before buy - [#105](https://github.com/bing0b0ng0/binance-trading-fabio/issues/105)
- [ ] Reset global configuration to initial configuration - [#97](https://github.com/bing0b0ng0/binance-trading-fabio/issues/97)
- [ ] Support multilingual frontend - [#56](https://github.com/bing0b0ng0/binance-trading-fabio/issues/56)
- [ ] Non linear stop price and chase function - [#246](https://github.com/bing0b0ng0/binance-trading-fabio/issues/246)
- [ ] Support STOP-LOSS configuration per grid trade for selling - [#261](https://github.com/bing0b0ng0/binance-trading-fabio/issues/261)

## Donations

If you find this project helpful, feel free to make a small
[donation](https://github.com/bing0b0ng0/binance-trading-fabio/blob/master/DONATIONS.md)
to the developer.
...
Thanks to all contributors :heart: [Click to see our heroes](https://github.com/bing0b0ng0/binance-trading-fabio/graphs/contributors)
